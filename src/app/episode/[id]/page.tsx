              ...
              {userRating > 0 && (
                <>
                  <textarea
                    ...
                    className="w-full bg-slate-700 text-white rounded px-4 py-2 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500 h-24 resize-none"
                  />
                  <button
