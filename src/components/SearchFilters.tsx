    ...
    <div className="bg-slate-800 rounded-lg p-4 mb-6">
      ...
      <div className="mb-4">
        <input
          ...
          className="w-full bg-slate-700 text-white rounded px-4 py-2 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
        />
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mb-4">
        ...
        <div className="relative">
          <input
            ...
            className="w-full bg-slate-700 text-white rounded px-3 py-2 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500"
          />
